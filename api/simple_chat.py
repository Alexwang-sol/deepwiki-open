...
class ChatCompletionRequest(BaseModel):
    ...
    sub_path: Optional[str] = Field(None, description="subpath for the subpath mode url")
...
async def chat_completions_stream(request: ChatCompletionRequest):
    ...
    try:
        ...
        try:
            ...
            request_rag.prepare_retriever(request.repo_url, request.type, request.token, excluded_dirs, excluded_files, included_dirs, included_files, request.sub_path)
